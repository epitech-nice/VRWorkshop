# Challenge : Architecture et Interactions VR
...
Pour chaque étape, suivez le guide ci-dessous. Référez-vous aux lettres entre parenthèses (ex: (B)) pour savoir où regarder sur votre écran, selon le document "L'interface de Unity".
